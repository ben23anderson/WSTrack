      ...
      <div className="min-h-screen bg-gray-50 flex items-start justify-center pt-16 px-4">
        <div className="w-full max-w-sm text-center space-y-4">
          ...
          <p className="text-xs text-gray-400">Didn't receive it? Check your spam folder or{' '}
            <Link to="/login" className="text-blue-600 hover:underline">sign in</Link> to resend.
          </p>
        </div>
      </div>
    );
      ...
      <div className="w-full max-w-sm">
        ...
        <form onSubmit={(e) => void handleSubmit(e)} className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 space-y-4">
          ...
          <div>
            ...
            <input id="name" type="text" autoComplete="name" required value={name} onChange={(e) => setName(e.target.value)} className="w-full border border-gray-300 rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 min-h-11" />
          </div>
          <div>
